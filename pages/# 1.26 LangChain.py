...
initialize_page()
st.info("Powered by Ollama/llama3 and DuckDuckGo search, this chatbot provides real-time answers, accurate search results, and remembers past conversations.", icon="💡")
